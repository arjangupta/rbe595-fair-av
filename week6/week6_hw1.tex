...
\begin{homeworkProblem}[Problem 1]
    ...
    where $h$ is the height of the center of gravity of the vehicle, $a_1$ is the distance from the front
    axle to the center of gravity, and $a_2$ is the distance from the rear axle to the center of gravity.

    Substituting this into the integral in equation (1), we get

    \begin{equation}
        100 = \int_{0}^{\tau_{100}} g \left( \frac{\mu}{1 + \mu \frac{h}{a_1 + a_2}} \frac{a_2}{a_1 + a_2} \right) \, dt
    \end{equation}

    Since everything in the integrand is constant, we can pull it out of the integral to get

    \begin{equation}
        100 = g \left( \frac{\mu}{1 + \mu \frac{h}{a_1 + a_2}} \frac{a_2}{a_1 + a_2} \right) \int_{0}^{\tau_{100}} \, dt
    \end{equation}

    Therefore, the minimum time to accelerate a FWD vehicle from 0 speed to 100 km/h is

    \begin{equation}
        \tau_{100} = \frac{100}{g \left( \frac{\mu}{1 + \mu \frac{h}{a_1 + a_2}} \frac{a_2}{a_1 + a_2} \right)}
    \end{equation}

    \subsection{Rear-Wheel Drive}

    The maximum acceleration that a vehicle can achieve in rear-wheel drive configuration is given by

    \begin{equation}
        a_{\text{max}} = g \left( \frac{\mu}{1 - \mu \frac{h}{a_1 + a_2}} \frac{a_1}{a_1 + a_2} \right)
    \end{equation}

    Following similar steps as above, we get the minimum time to accelerate a RWD vehicle from 0 speed to 100 km/h as

    \begin{equation}
        \tau_{100} = \frac{100}{g \left( \frac{\mu}{1 - \mu \frac{h}{a_1 + a_2}} \frac{a_1}{a_1 + a_2} \right)}
    \end{equation}
